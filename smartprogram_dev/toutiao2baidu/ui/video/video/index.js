...
Component({
  ...
  methods: {
    ...
    // 广告做不了
    trigger_adstart: function trigger_adstart(e) {
      this.triggerEvent('adstart', e);
    },
    trigger_adended: function trigger_adended(e) {
      this.triggerEvent('adended', e);
    },
    trigger_adload: function trigger_adload(e) {
      this.triggerEvent('adload', e);
    },
    trigger_adclose: function trigger_adclose(e) {
      this.triggerEvent('adclose', e);
    },
    trigger_aderror: function trigger_aderror(e) {
